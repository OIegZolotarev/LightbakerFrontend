/*
	...
	OpenGL loader generated by glad 0.1.35 on Thu May 12 18:09:46 2022.
	...
	Commandline:
		--profile="compatibility" --api="gl=2.0" --generator="c" --spec="gl" --extensions="GL_ARB_depth_texture,GL_ARB_vertex_array_object,GL_EXT_framebuffer_object,GL_EXT_packed_depth_stencil,GL_NV_texture_rectangle"
	Online:
		https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D2.0&extensions=GL_ARB_depth_texture&extensions=GL_ARB_vertex_array_object&extensions=GL_EXT_framebuffer_object&extensions=GL_EXT_packed_depth_stencil&extensions=GL_NV_texture_rectangle
*/
...
int gladLoadGL(void) {
	...
	int open_gl_status = open_gl();
	
	printf("open_gl_status = %d\n",open_gl_status);
