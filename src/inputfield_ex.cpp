...
void InputFieldEx::RenderGui()
{
    ...
    {
        ImGui::SameLine();
        if (ImGuiHelpers::ButtonWithCommonIcon(CommonIcons::InputFieldMore, "###SelectFile", LV_TOOLBAR_ICON_SIZE))
    ...
    {
        ImGui::SameLine();
        if (ImGuiHelpers::ButtonWithCommonIcon(CommonIcons::InputFieldClear, "###ClearFile", LV_TOOLBAR_ICON_SIZE))
