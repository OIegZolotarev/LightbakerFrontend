...
CProfileNode *gCurrentNodes[BT_QUICKPROF_MAX_THREAD_COUNT] = {
    &gRoots[0],  &gRoots[1],  &gRoots[2],  &gRoots[3],  &gRoots[4],  &gRoots[5],  &gRoots[6],  &gRoots[7],
    &gRoots[8],  &gRoots[9],  &gRoots[10], &gRoots[11], &gRoots[12], &gRoots[13], &gRoots[14], &gRoots[15],
    &gRoots[16], &gRoots[17], &gRoots[18], &gRoots[19], &gRoots[20], &gRoots[21], &gRoots[22], &gRoots[23],
    &gRoots[24], &gRoots[25], &gRoots[26], &gRoots[27], &gRoots[28], &gRoots[29], &gRoots[30], &gRoots[31],
    &gRoots[32], &gRoots[33], &gRoots[34], &gRoots[35], &gRoots[36], &gRoots[37], &gRoots[38], &gRoots[39],
    &gRoots[40], &gRoots[41], &gRoots[42], &gRoots[43], &gRoots[44], &gRoots[45], &gRoots[46], &gRoots[47],
    &gRoots[48], &gRoots[49], &gRoots[50], &gRoots[51], &gRoots[52], &gRoots[53], &gRoots[54], &gRoots[55],
    &gRoots[56], &gRoots[57], &gRoots[58], &gRoots[59], &gRoots[60], &gRoots[61], &gRoots[62], &gRoots[63],
};
...
// extern void Profiler_Con_Printf(const char *fmt, ...);
// extern void Profiler_SetSpacing(int spacing);
// extern int  FramesSinceReset();
...
//     int   i;
//     int   frames_since_reset = FramesSinceReset();
//     Profiler_SetSpacing(spacing);
//     Profiler_Con_Printf("----------------------------------\n");
//     Profiler_SetSpacing(spacing);
//     Profiler_Con_Printf("Profiling: %s (total running time: %.3f ms) ---\n", profileIterator->Get_Current_Parent_Name(),
//                         parent_time);
//     float totalTime = 0.f;
// 
//     int numChildren = 0;
...
//             Profiler_SetSpacing(spacing);
//         }
//         Profiler_Con_Printf("%d -- %s (%.2f %% - %.3f ms) :: %.3f ms / frame (%d calls)\n", i,
//                             profileIterator->Get_Current_Name(), fraction, current_total_time,
...
//     {
//         // Profiler_Con_Printf("what's wrong\n");
//     }
// 
//     Profiler_SetSpacing(spacing);
//     Profiler_Con_Printf("%s (%.3f %%) :: %.3f ms\n", "Unaccounted:",
